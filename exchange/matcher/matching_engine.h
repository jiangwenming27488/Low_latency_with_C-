...
namespace Exchange
{
	class MatchingEngine final 
	{
		public: 
			...
			/*Write market data update to the lock free queue for the market date publisher to consume.*/
			...
			/*Main loop for this thread - process incoming client request which in turn generates client responses and market updates.*/
			auto run() noexcept 
			{
