...
namespace Exchange 
{
	...
	struct MEOrder
	{
		...
		/*"MEOrder" also serves as a node in the doubly linked list of all orders at price level arranged in "FIFO" order*/
	...
	struct MEOrdersAtPrice
	{
		...
		/*"MEOrdersAtPrice" also servers as a node in a doubly linked list of price levels arranged in order from most "aggressive" to "least aggresive" price*/
