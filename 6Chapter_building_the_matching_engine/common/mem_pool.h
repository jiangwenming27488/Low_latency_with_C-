...
namespace Common
{
	template<typename T> class MemPool final 
	{
		public: 
			...
			{
				auto obj_block = &(stor_[next_free_index_]);
			...
			auto deallocate(const T *elem) noexcept
			{
				...
				stor_[elem_index].is_free_ = true; 
			}
		...
		private: 
			/*It is better to have on vector of structs with two objects than two vectors of one object. 
