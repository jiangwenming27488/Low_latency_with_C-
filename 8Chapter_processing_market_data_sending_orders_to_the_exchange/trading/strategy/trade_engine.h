...
namespace Trading
{
	class TradeEngine
	{
		public: 
			...
			auto silentSeconds()
			{
				return (Common::getCurrentNanos() - last_event_time_) / NANOS_TO_SEC; 
			}
			...
			/*Deleted default, copy & move consturctors and assignment-operators.*/
			TradeEngine() = delete; 
		...
		private: 
			...
			Exchange::ClientRequestLFQueue *outgoing_owg_requests_ = nullptr; 
