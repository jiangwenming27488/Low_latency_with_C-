...
namespace Common
{
	template<typename T> class MemPool final
	{
		...
		private:
			 ...
			 * We would have to measure to see which on yields better performance. 
			 * It is good to have objects on the stack but performance starts getting worse as the size ofthe pool increases*/
