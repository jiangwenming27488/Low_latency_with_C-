...
namespace Common
{
	...
	/*Creates a threadinstance, sets affinity on it, assigns it a name and passes the function to be run on tht thread as well as the arguments to the function*/
