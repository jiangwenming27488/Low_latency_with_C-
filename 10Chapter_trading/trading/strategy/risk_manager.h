...
namespace Trading 
{
	...
	/*Enumeration that captures the result of a risk check - ALLOWED means it passed all risk checks.
	 * The other values represent the failure reason*/
