...
namespace Trading
{
	class TradeEngine
	{
		public: 
			...
			/*Process changes to the order book - updates the position keeper, feature engine and informs the trading alogrithm about the update*/
