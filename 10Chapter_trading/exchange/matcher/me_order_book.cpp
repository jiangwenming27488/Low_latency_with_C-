...
namespace Exchange
{
	 ...
	 * It will check to see if this new order matches an existing passive order with opposit side, and perform the matching if that is the case*/
	...
	/*Attempt to cancel on order in the order book, issue a cancel-rejection if order does not exist.*/
