...
namespace Exchange
{
	...
	class FIFOSequencer
	{
		public: 
			...
			/*Queue up a client requets, not processed immediately, processed when "sequenceAndPublish()" is called.*/
		...
		private: 
			/*Lock free queue used to publish client requests to, so the that the matching engine can consume them*/
