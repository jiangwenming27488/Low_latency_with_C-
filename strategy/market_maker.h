...
namespace Trading
{
	...
	{
		public: 
			MarketMaker(Common::Logger *logger, TradeEngine *trade_engine, const FeatureEngine *feature_engine, OrderManager *order_manager, const TradeEngineCfgHashMap &ticker_cfg); 

			/*Process order book updates, fetch the fair market price from the feature engine, check agaijnst the trading threshold and modify the passive orders.*/
			...
			/*Process trade event, which for the market making algorithm is none. */
			...
			/*Process client responsres for the strategy's orders*/
		...
		private: 
			...
			/*Used by market making algorithm to manage its passive orders.*/
