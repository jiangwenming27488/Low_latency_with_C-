...
namespace Trading 
{
	...
	/*Manager orders for a trading algorithm , hides the complexity of order management to simplify trading strategies.*/
	class OrderManager
	{
		public: 
			...
			/*Send a "cancel" for the specified order, and update the "OMOrder" onject passed here */
			...
			/*Have orders of quantity clip at the specified by and sell prices. 
		...
		private: 
			/*The Parent trade engine object, used to send out clientrequests*/
