...
namespace Trading
{
	...
	class MarketOrderBook final
	{
		public: 
			...
			/*Update the BO abstration, the two boolean parameters represent if the by or the sell (or both) sides or both need to be updated.*/
		...
		private: 
			...
			/*Memory pool (you the one you have heard so much about lol) to manage "MarketOrdersAtPrice" objects.*/
			MemPool<MarketOrdersAtPrice> orders_at_price_pool_; 

			/*Pointer to beginning / best prices / top of book of buy and seel price levels*/
			...
			/*Memory pool to manage "MarketOrder" objects "#HeapBods2024"*/
		...
		private: 
			...
			/*Remove and de-allocate provided order from the constainers*/
			...
			/*Add a single order to the end of the FIFO queueu at the price level that this order belongs in*/
