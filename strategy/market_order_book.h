...
namespace Trading
{
	...
	class MarketOrderBook final
	{
		public: 
			...
			/*Update the BBO (best bid offer) abstraction, the two boolean parameters represent if the buy or the sell (or both) sides or both need to be updated*/
			...
			auto toString(bool detailed, bool validty_check) const -> std::string; 
		...
		private: 
			...
			/*Parent trade engine that owns this limit order book, used to send notification when book changes or trades occur.*/
