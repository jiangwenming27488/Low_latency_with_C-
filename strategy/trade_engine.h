...
namespace Trading
{
	class TradeEngine
	{
		public: 
			...
			/*Main loop for this thread - processes incoming client repsones and market data updates which in turn may generate client requests. */
			auto run() noexcept -> void; 

			/*Write a client request to the lock free queue for the order server to consume and send tothe exchange.*/
