...
namespace Trading 
{
	/*Sentinel value to represent invalid / unitiialized feature value.*/
	...
	class FeatureEngine
	{
		public: 
			...
			/*Process a change in order book and in the case compute the fair market price*/
			auto onOrderBookUpdate(TickerId ticker_id, Price price, Side side, MarketOrderBook* book) noexcept -> void
			{ 	/*"BBO" stand for "BEST BID OFFER" abstration*/
