/*We will create and launch two threads with a dummy task (you can edit the code and replace it with any task) of adding the two arguments 'a' and 'b' passed to it. 
 * Then, we wait for the threads to finish execution before exiting the program.*/
