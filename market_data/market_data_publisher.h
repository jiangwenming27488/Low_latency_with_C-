...
namespace Exchange 
{
	...
	{
		public: 
			MarketDataPublisher(MEMarketUpdateLFQueue *market_updates, const std::string &iface, const std::string &snapsshot_ip, int snapshot_port, const std::string &incremental_ip, int incremental_port); 
		...
		private: 
			 ...
			 * (Check the common dir for the "mcast.h" file to see the implemen)*/
