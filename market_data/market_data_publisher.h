	...
	class MarketDataPublisher 
	{
		public: 
			...
			auto start() 
			{
				...
				ASSERT(Common::createAndStartThread(-1, "Exchange/MarketDataPublisher", [this]() { run(); }) != nullptr, "Faile to start MarketData thread."); 
		...
		private: 
			...
			/*Multicast socket to represnt the incremental market data stream*/
