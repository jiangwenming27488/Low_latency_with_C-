...
namespace Exchange 
{
	...
	{
		public: 
			MarketDataPublisher(MEMarketUpdataLFQueue *market_updates, const std::string &iface, const std::string &snapshot_ip, int snapshot_port, const std::string &incremental_ip, int incremental_port); 
		...
		private: 
			...
			MEMarketUpdataLFQueue *outgoing_md_updates_ = nullptr; 

			MDPMarketUpdateFLQueue snapshot_md_updates_; 
