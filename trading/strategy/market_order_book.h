...
namespace Trading 
{
	...
	class MarketOrderBook final
	{
		public: 
			...
			/*Update the "BBO" abstraction, the two bolean parameters represent if the buy or the "sell" (or both) sides or both need to be updated.*/
			...
			/*Deleted default, copy & move constructors ans assignment-operators*/
		...
		private: 
			...
			/*Memory prool to manage "MarketOrdersAtPrice" objects*/
		...
		private: 
			...
			/*Fetch and return the "MarketOrdersAtPrice" conrresponding to the provided price*/
