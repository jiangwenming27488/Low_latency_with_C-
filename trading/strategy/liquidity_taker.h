...
namespace Trading 
{
	class LiquidityTaker
	{
		public: 
			...
			{
				logger_->log("%:% %() % %\n", __FILE__, __LINE__, Common::getCurrentTimeStr(&time_str_), market_update->toString().c_str()); 
		...
		private: 
			/*The feature engine that drives the liquidity taking algo*/
			...
			/*Holds the trading configuration for the liquidity taking algo*/
