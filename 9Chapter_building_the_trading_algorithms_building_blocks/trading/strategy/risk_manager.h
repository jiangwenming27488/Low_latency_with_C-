...
namespace Trading
{
	...
	struct RiskInfo
	{
		...
		auto chekcPreTradeRisk(Side side, Qty qty) const noexcept
		{
			/*Check order-size*/
	...
	{
		public: 
			RiskManager(Common::Logger *logger, const PositionKeeper *position_keep, const TradeEngineCfgHashMap &ticker_cfg); 
