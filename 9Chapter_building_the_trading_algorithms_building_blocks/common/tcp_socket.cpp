...
namespace Common
{
	/*Create TCPSocet with provided attributes to either listen-on / connect-to*/
	...
	/*Called to publish outgoing data from the buffers as well as check for and callback if data is available in the read buffer.*/
	auto TCPSocket::sendAndREcv() noexcept -> bool 
	{
		...
		msghbr msg{&socket_attrib_, sizeof(socket_attrib_), &iov, 1, ctrl, sizeof(ctrl), 0}; 
