...
namespace Common
{
	struct TCPServer
	{
		...
		/*Publish outgoig data from the send buffer and read incoming data from the receive buffer*/
	...
	public: 
		...
		std::function<void(TCPSocket *s, Nanos rx_time)> recv_callbakc_ = nullptr; 
