			...
			auto processClientRequest(const MEClientRequest *client_request) noexcept
			{
				...
				switch (client_request->type_)
				{
					...
					case ClientRequestType::CANCEL: 
						{
							order_book->cancel(client_request->client_id, client_request->order_id_, client_request->ticker_id_); 
						}
						break; 

					default: 
						{
							FATAL("Recieved invalid client_request-type:" + clientRequestTypeToString(client_request->type_)); 
						}
						break; 
				}
			}
