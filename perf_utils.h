...
/*Start latency measurement using "rdtsc()".
 * Creates a variable called "TAG" in the local scope*/
#define START_MEASURE(TAG) const auto TAG = Common::rdtsc()

/*End latency measurement using "rdtsc()".
 * Expexts a variable callded "TAG" to already exist in the local scope */
